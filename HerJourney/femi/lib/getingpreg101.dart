...
class GettingPregnantScreen extends StatelessWidget {
  const GettingPregnantScreen({super.key});
          ...
          children: [
            Center(
              child: SizedBox(
                height: 350,
                  width: 420,
                child: Image.asset(
                  'assets/home/gettingpregnant.jpg', 
                  height: 300,
                  width: 420,
                  fit: BoxFit.fill,
                ),
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    backgroundImage: AssetImage('assets/Insights/healthyrelationship.jpg'), 
                    radius:30,
                  ),
                  SizedBox(width: 12),
                  Expanded(
            ...
            const VideoItem(
              title: "Welcome to getting pregnant 101 series",
              description:
                  "It seems that you’re curious about planning a healthy pregnancy...",
              duration: "00:32",
              thumbnail: 'assets/Insights/howtogetP.jpg', 
            ),
            const VideoItem(
              ...
              duration: "02:10",
              thumbnail: 'assets/Insights/pregnant.jpg', 
            ),
            const VideoItem(
              title: "Lifestyle",
              description:
              ...
              duration: "06:11",
              thumbnail: 'assets/Insights/p9.jpg', 
            ),
          ],
        ),
      ),
